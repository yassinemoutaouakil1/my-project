...
$sContent = $sContent -replace '"fleet-passengers": "Passagers"', '"fleet-passengers-7": "Jusqu''à 7 Passagers",
        "fleet-passengers-8": "Jusqu''à 8 Passagers"'
$sContent = $sContent -replace '"fleet-luggage": "Espace Bagages"', '"fleet-luggage-7": "7 Grands Bagages",
        "fleet-luggage-8": "8 Grands Bagages"'
$sContent = $sContent -replace '"fleet-ac": "Climatisation"', '"fleet-ac": "Climatisation Réversible",
        "fleet-ac-double": "Double Climatisation",
        "fleet-ac-full": "Entièrement Climatisé"'
