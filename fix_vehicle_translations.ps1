...
$frExtra = @"
        ...
        "ren-desc-full": "Le Renault Trafic allie praticité et confort. Il offre une valeur inégalée sans sacrifier la qualité de votre transfert.",
        "fleet-luggage-8-bag": "8 Sacs de Voyage",
        "fleet-roomy": "Intérieur Spacieux",
        "ideal-for": "Idéal pour :",
        "ren-f1-t": "Excursions en Famille :",
        "ren-f1-p": "De la place pour tout le monde et leurs valises.",
        "ren-f2-t": "Transferts Aéroport de Groupe :",
        "ren-f2-p": "Transport très rentable.",
        "ren-f3-t": "Excursions d'une Journée :",
        "ren-f3-p": "Sièges confortables pour explorer le Maroc.",
