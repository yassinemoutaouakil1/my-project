...
foreach ($file in $files) {
    ...
    $content = $content -replace '(?i)<link rel="canonical" href="https://safia-transfers\.com/(?:en/|fr/)?index\.html">', '<link rel="canonical" href="https://safia-transfers.com/">'
    
    $content = $content -replace '(?i)<link rel="alternate" hreflang="en" href="https://safia-transfers\.com/(?:en/|fr/)?index\.html">', '<link rel="alternate" hreflang="en" href="https://safia-transfers.com/">'
    $content = $content -replace '(?i)<link rel="alternate" hreflang="fr" href="https://safia-transfers\.com/(?:en/|fr/)?index\.html">', '<link rel="alternate" hreflang="fr" href="https://safia-transfers.com/fr/">'
    
    $content = $content -replace '(?i)href="https://safia-transfers\.com/(?:en/)?index\.html"', 'href="https://safia-transfers.com/"'
    $content = $content -replace '(?i)href="https://safia-transfers\.com/fr/index\.html"', 'href="https://safia-transfers.com/fr/"'
    
    $content = $content -replace '(?i)content="https://safia-transfers\.com/(?:en/|fr/)?index\.html"', 'content="https://safia-transfers.com/"'
