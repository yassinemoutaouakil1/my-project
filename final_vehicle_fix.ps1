...
$frNew = @"
        ...
        "ren-desc-full": "Le Renault Trafic allie praticitÃ© et confort. C'est le choix intelligent pour les grands groupes Ã  la recherche d'un transport fiable Ã  travers le Maroc sans se ruiner.",
        "fleet-passengers-9": "9 Passagers",
        "fleet-luggage-big": "Grand Espace Bagages",
        "fleet-ac-sys": "SystÃ¨me de Climatisation",
        "key-features": "CaractÃ©ristiques ClÃ©s",
        "ren-f1-t": "AdaptÃ© aux Groupes :",
        "ren-f1-p": "Accueille jusqu'Ã  9 personnes en toute sÃ©curitÃ©.",
        "ren-f2-t": "Polyvalent :",
        "ren-f2-p": "IdÃ©al pour les transferts urbains et les excursions.",
        "ren-f3-t": "Ã‰conomique :",
        "ren-f3-p": "Excellent rapport qualitÃ©-prix.",
        "ren-f4-t": "SÃ»r :",
        "ren-f4-p": "RÃ©guliÃ¨rement entretenu et inspectÃ©.",
"@
...
$c = $c -replace '(?s)"ford-sub":.*?"ford-f4-p": "Suspension avancÃ©e pour les longs trajets\.",', ''
...
# Insert French
$c = $c -replace '"btn-details": "Voir en DÃ©tails",', "`"btn-details`": `"Voir en DÃ©tails`",`n$frNew"
