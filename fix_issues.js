...
for (let file of htmlFiles) {
    ...
    */
    ...
    let phone = phoneMatch ? phoneMatch[0].split('"')[3] : "+212600000000";
  ...
  <script type="application/ld+json">
  {
    ...
    content = content.replace(/<link rel="canonical" href="https:\/\/moutaouakil-transfers\.com\/(?:en\/|fr\/)?index\.html">/gi, '<link rel="canonical" href="https://moutaouakil-transfers.com/">');

    // Note: For other pages, we can just replace index.html to / for the root.
    content = content.replace(/href="https:\/\/moutaouakil-transfers\.com\/(?:en\/)?index\.html"/gi, 'href="https://moutaouakil-transfers.com/"');
    content = content.replace(/href="https:\/\/moutaouakil-transfers\.com\/fr\/index\.html"/gi, 'href="https://moutaouakil-transfers.com/fr/"');

    content = content.replace(/content="https:\/\/moutaouakil-transfers\.com\/(?:en\/|fr\/)?index\.html"/gi, 'content="https://moutaouakil-transfers.com/"');
    ...
    if (file === 'index.html' || file === 'index_clean.html' || file === '.\\index.html') {
        content = content.replace(/<link rel="alternate" hreflang="en" href="https:\/\/moutaouakil-transfers\.com\/index\.html">/g, '<link rel="alternate" hreflang="en" href="https://moutaouakil-transfers.com/">');
        content = content.replace(/<link rel="alternate" hreflang="fr" href="https:\/\/moutaouakil-transfers\.com\/index\.html">/g, '<link rel="alternate" hreflang="fr" href="https://moutaouakil-transfers.com/fr/">');
    }
